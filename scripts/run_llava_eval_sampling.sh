python vicua/vicuna.py --output-json predictions_sampling/vicuna_jailbreakFalse_1.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --output-json predictions_sampling/vicuna_jailbreakFalse_2.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --output-json predictions_sampling/vicuna_jailbreakFalse_3.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --output-json predictions_sampling/vicuna_jailbreakFalse_4.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --output-json predictions_sampling/vicuna_jailbreakFalse_5.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
...
python vicua/vicuna.py --use-jailbreak-prompt --output-json predictions_sampling/vicuna_jailbreakTrue_1.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --use-jailbreak-prompt --output-json predictions_sampling/vicuna_jailbreakTrue_2.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --use-jailbreak-prompt --output-json predictions_sampling/vicuna_jailbreakTrue_3.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --use-jailbreak-prompt --output-json predictions_sampling/vicuna_jailbreakTrue_4.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
python vicua/vicuna.py --use-jailbreak-prompt --output-json predictions_sampling/vicuna_jailbreakTrue_5.json --top-p 0.9 --jailbreak-csv data/jailbreak-prompts2.csv
